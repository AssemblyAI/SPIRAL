...
#            - init from checkpoint with custom function
#            - support setting optim_param_groups.
...
from spiral_nemo.core import optim
from spiral_nemo.core.classes.common import Model
from spiral_nemo.core.config.modelPT import ModelPTConfig
from spiral_nemo.core.optim import prepare_lr_scheduler
from spiral_nemo.utils import config_utils, logging, model_utils
from spiral_nemo.utils.app_state import AppState
...
class ModelPT(LightningModule, Model):
    ...
    def _eff_save_to(self, save_path: str):
        ...
        the default `save_to` recipe from spiral_nemoCookbook.
    ...
    def _eff_restore_from(
        ...
        the default `restore_from` recipe from spiral_nemoCookbook.
