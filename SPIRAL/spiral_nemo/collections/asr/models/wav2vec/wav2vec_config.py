...
class QuantizerConfig:
    ...
    targets_bottleneck_dim: Optional[int] = None
    targets_bottleneck_act_fn: Optional[str] = None
    targets_bottleneck_dropout: float = 0.0
...
class Wav2VecMaskingConfig:
    ...
    mask_shrink_to_batch_min: bool = True
    mask_channel_shrink_to_batch_min: bool = False
