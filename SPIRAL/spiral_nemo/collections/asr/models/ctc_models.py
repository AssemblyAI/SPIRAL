...
#            - make ctc model compatible with previous modifications
#            - disable compute training wer, print eval wer of first three batches
#            - support set blank id for CTC models
#            - merge update to CTC models
...
from spiral_nemo.collections.asr.data import audio_to_text_dataset
from spiral_nemo.collections.asr.data.audio_to_text_dali import DALIOutputs
from spiral_nemo.collections.asr.losses.ctc import CTCLoss
from spiral_nemo.collections.asr.metrics.wer import WER
from spiral_nemo.collections.asr.models.asr_model import ASRModel, ExportableEncDecModel
...
from spiral_nemo.core.neural_types import AudioSignal, LabelsType, LengthsType, LogprobsType, NeuralType, SpectrogramType
...
class EncDecCTCModel(ASRModel, ExportableEncDecModel):
    ...
    def forward(
        ...
        encoded, encoded_len, _ = self.encoder(audio_signal=processed_signal, length=processed_signal_length)
