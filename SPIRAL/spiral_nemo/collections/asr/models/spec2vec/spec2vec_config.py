...
from spiral_nemo.collections.asr.models.configs.common_config import Conv2dBlock, Conv1dNormAct, DatasetConfig, Tokenizer
...
class FeatureEncoderConfig:
    _target_: str = 'spiral_nemo.collections.asr.parts.spec2vec.FeatureEncoder'
    feat_in: int = MISSING
...
@dataclass
class ST2VecRNNTFinetuneModelConfig(ModelConfig):
    pretrain_chkpt_path: Optional[str] = MISSING
    encoder_type: str = 'st'
    encoder: Any = MISSING
    decoder: Any = MISSING
    model_defaults: Any = MISSING
    joint: Any = MISSING
    decoding: Any = MISSING
    preprocessor: Any = MISSING
    loss: Any = MISSING
    use_teacher_encoder: bool = False
    labels: Optional[List[str]] = None
    tokenizer: Optional[Tokenizer] = None
