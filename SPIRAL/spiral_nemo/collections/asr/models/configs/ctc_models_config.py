...
from spiral_nemo.collections.asr.models.configs.common_config import Tokenizer, DatasetConfig, OptimConfig, Conv1dNormAct, \
    ProjUpsampling
from spiral_nemo.collections.asr.models.spec2vec.spec2vec_config import ProjectorConfig
from spiral_nemo.collections.asr.modules.audio_preprocessing import (
    AudioToMelSpectrogramPreprocessorConfig,
    SpectrogramAugmentationConfig,
)
from spiral_nemo.core.config import modelPT as model_cfg


@dataclass
class ConvASRDecoderConfig:
    _target_: str = 'spiral_nemo.collections.asr.modules.ConvASRDecoder'
    feat_in: int = MISSING
    num_classes: int = 0
