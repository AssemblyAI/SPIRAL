...
--config_name=italian_romance_finetune \
--config_path=examples/asr/conf/spiral \
--model_type=ctc_finetune \
--num_nodes=1 \
--num_gpus=8 \
--data_dir=/home/francismccann/aai-us-central1/datasets/wav2vec2_finetune \
--manifest_dir=/home/francismccann/aai-us-central1/datasets/wav2vec2_finetune/manifests/ \
--model_save_dir=it_large_ft_romance_base \
--init_chkpt_dir=/home/francismccann/aai-us-central1/experiments/w2v2_finetune/francis \
--init_chkpt_file=romance-pretrain-cp.ckpt
...
vocabulary = '/home/francismccann/aai-us-central1/datasets/wav2vec2_finetune/vocabs/vocab_it.json'
...
model.train_ds = DatasetConfig(
    manifest_filepath='italian/mls_it.json,italian/cv_it_train.json,italian/ailabs_it.json,italian/voxforge_it.json,en_ner.json',
    labels=LABELS,
...
model.validation_ds = DatasetConfig(
    manifest_filepath='italian/cv_it_test.json',
    labels=LABELS,
    sample_rate=sample_rate,
    batch_size=10,
    shuffle=False,
...
model.noise_perturb = NoisePerturbConfig(
    manifest_path=["/home/francismccann/aai-us-central1/datasets/wav2vec2_finetune/manifests/DNS-noise.json"],
    min_snr_db=0.,
    max_snr_db=20.,
    ratio=0.3,
    target_sr=sample_rate,
    data_dir='/home/francismccann/aai-us-central1/datasets/',
    cache_noise=True,
)
