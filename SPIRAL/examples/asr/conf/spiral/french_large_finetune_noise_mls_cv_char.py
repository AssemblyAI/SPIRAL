...
vocabulary = '/home/cirrascale/frmccann/SPIRAL/SPIRAL/vocab_v2.json'
...
model.train_ds = DatasetConfig(
    manifest_filepath='cv_fr_train.json,mls_fr_train.json,en_ner_fr_train.json',
    labels=LABELS,
...
model.validation_ds = DatasetConfig(
    manifest_filepath='cv_fr_test.json,mls_fr_test.json,en_ner_fr_test.json',
    labels=LABELS,
    sample_rate=sample_rate,
    batch_size=20,
    shuffle=False,
