...
model.train_ds = AudioDatasetConfig(
    manifest_filepath='danish_train.json,dutch_train.json,norwegian_train.json,portuguesept-br_train.json,portuguesept-pt_train.json,swedish_train.json',
    sample_rate=sample_rate,
    batch_size=80,
    min_duration=2.0,
    crop_size=256000,
...
model.validation_ds = AudioDatasetConfig(
    manifest_filepath='danish_test.json,dutch_test.json,norwegian_test.json,portuguesept-br_test.json,portuguesept-pt_test.json,swedish_test.json',
    sample_rate=sample_rate,
    batch_size=80,
    min_duration=2.0,
    crop_size=256000,
